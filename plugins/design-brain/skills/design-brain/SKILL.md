...
| `/db-ask` | Ask semantic questions against design brain context |
| `/db-stats` | Vault metrics and health report |
| `/db-export` | Export tokens (`tailwind`, `style-dictionary`, or `css-in-js`) |
