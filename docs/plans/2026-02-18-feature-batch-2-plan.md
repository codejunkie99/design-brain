...
Run: `cd /Users/example/design-brain && npm run build && node --test tests/tokenNaming.test.mjs`
...
Run: `cd /Users/example/design-brain && npm run build && node --test tests/cssInJs.test.mjs`
...
Run: `cd /Users/example/design-brain && npm run build && node --test tests/componentGraph.test.mjs`
Expected: FAIL — module not found
...
Run: `cd /Users/example/design-brain && npm run build && node --test tests/reviewChecklist.test.mjs`
Expected: FAIL — module not found
...
Run: `cd /Users/example/design-brain && npm run build && node --test tests/systemDiff.test.mjs`
Expected: FAIL — module not found
...
Run: `cd /Users/example/design-brain && npm run build && npm test`
